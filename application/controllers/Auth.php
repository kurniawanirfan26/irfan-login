...
class auth extends CI_Controller
{
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    Wrong Password Guys !</div>');
                    redirect('auth');
                }
            } else {
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
                This user is not active</div>');
                redirect('auth');
            }
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() ==  false) {
            $data['title'] = 'Irfan User Registration';
            $this->load->view('templates/auth_header', $data);
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
            Congrats!Your Account has been Registered. Please activace your account</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('irfan@carmel.co.id', "Kurniawan Irfan Nauval");
